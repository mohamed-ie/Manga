...
fun Manga.title(languageTag: String) =
    titles.run { get(languageTag) ?: get("en") ?: firstNotNullOfOrNull { it.value } ?: "" }

fun Manga.description(languageTag: String) =
    descriptions.run { get(languageTag) ?: get("en") ?: firstNotNullOfOrNull { it.value } ?: "" }
